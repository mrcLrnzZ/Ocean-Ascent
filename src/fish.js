...
export const SPRITE_DATA = {
    // Level 1: Surface
    anchovy: { src: 'assets/fish/anchovyy.png', almanacSrc: 'assets/almanac/almanacAnchovy.png', frames: 4, renderScale: 0.2, name: 'Anchovy', rarity: 'common', price: 10, desc: 'A small silvery fish that travels in massive schools near the surface. Quick and abundant, it forms the backbone of many ocean food chains.', scale: 1 },
    sardine: { src: 'assets/fish/placeholderfish.png', almanacSrc: 'assets/almanac/almanacPlaceholderfish.png', frames: 3, renderScale: 0.22, name: 'Sardine', rarity: 'common', price: 12, desc: 'A swift schooling fish often found in shimmering clusters. Though small, its numbers make it a vital prey for larger predators.', scale: 1 },
    clownfish: { src: 'assets/fish/placeholderfish.png', almanacSrc: 'assets/almanac/almanacPlaceholderfish.png', frames: 3, renderScale: 0.18, name: 'Clownfish', rarity: 'common', price: 15, desc: 'A vibrant reef dweller known for its bright colors and symbiotic bond with sea anemones. Rarely strays far from its home.', scale: 1 },
    ...
    // Level 3: Deep
    choifish: { src: 'assets/fish/choifish.png', almanacSrc: 'assets/almanac/almanacChoifish.png', frames: 6, renderScale: 0.45, name: 'Choifish', rarity: 'rare', price: 60, desc: 'A deep-water species with a sturdy build. It thrives in colder regions where pressure and darkness dominate.', scale: 1.4 },
    pufferfish: { src: 'assets/fish/placeholderfish.png', almanacSrc: 'assets/almanac/almanacPlaceholderfish.png', frames: 3, renderScale: 0.45, name: 'Pufferfish', rarity: 'rare', price: 70, desc: 'A curious fish capable of inflating its body as a defense mechanism. Beneath its charm lies a potent natural toxin.', scale: 1 },
    turtle: { src: 'assets/fish/turtle.png', almanacSrc: 'assets/almanac/almanacTurtle.png', frames: 5, renderScale: 0.88, name: 'Turtle', rarity: 'rare', price: 75, desc: 'A massive, slow-moving marine reptile. Despite its calm demeanor, it can dive deep in search of jellyfish and other prey.', scale: 1.8 },

    // Level 4: Trench
    halfmoon: { src: 'assets/fish/halfmoon.png', almanacSrc: 'assets/almanac/almanacHalfmoon.png', frames: 6, renderScale: 0.59, name: 'Halfmoon', rarity: 'epic', price: 200, desc: 'A rare deep-sea creature with a glowing crescent tail. It appears only under calm conditions, shimmering like moonlight.', scale: 1.8 },
    ...
    kraken: { src: 'assets/fish/kraken.png', almanacSrc: 'assets/almanac/almanacKraken.png', frames: 4, renderScale: 5, name: 'Kraken', rarity: 'legendary', price: 1000, desc: 'A legendary beast of the deep. Its massive tentacles are said to drag entire vessels into the abyss without a trace.', scale: 2.0 }
};
