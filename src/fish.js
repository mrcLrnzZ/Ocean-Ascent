...
export const SPRITE_DATA = {
    ...
    // Level 1: Surface
    anchovy: { src: 'assets/fish/anchovyy.png', almanacSrc: 'assets/almanac/almanacAnchovy.png', frames: 4, renderScale: 0.3, name: 'Anchovy', rarity: 'common', price: 5, hungerValue: 0.5, desc: 'A small silvery fish that travels in massive schools near the surface.', scale: 1 },
    bluetang: { src: 'assets/fish/bluetang.png', almanacSrc: 'assets/almanac/almanacBluetang.png', frames: 5, renderScale: 1, name: 'Bluetang', rarity: 'rare', price: 7, hungerValue: 0.5, desc: 'A swift schooling fish often found in shimmering clusters.', scale: 1.3 },
    clownfish: { src: 'assets/fish/clownfish.png', almanacSrc: 'assets/almanac/almanacClownfish.png', frames: 5, renderScale: 1, name: 'Clownfish', rarity: 'common', price: 10, hungerValue: 1, desc: 'A vibrant reef dweller known for its bright colors.', scale: 1.4 },

    // Level 2: Shallows
    swordfish: { src: 'assets/fish/swordfish.png', almanacSrc: 'assets/almanac/almanacSwordfish.png', frames: 4, renderScale: 0.29, name: 'Swordfish', rarity: 'uncommon', price: 20, hungerValue: 1.5, desc: 'Recognized by its long, blade-like snout.', scale: 1.2 },
    flowerhead: { src: 'assets/fish/flowerhead.png', almanacSrc: 'assets/almanac/almanacFlowerhead.png', frames: 6, renderScale: 0.29, name: 'Flowerhead', rarity: 'uncommon', price: 25, hungerValue: 1.8, desc: 'An agile fish with elegant movements.', scale: 1.4 },
    ...
    sunfish: { src: 'assets/fish/sunfish.png', almanacSrc: 'assets/almanac/almanacSunfish.png', frames: 4, renderScale: 3.88, name: 'Sunfish', rarity: 'rare', price: 65, hungerValue: 2.5, desc: 'Bizarre creature that basks near the surface.', scale: 1.5 },
    // Level 4: Trench
    ...
    orca: { src: 'assets/fish/orca.png', almanacSrc: 'assets/almanac/almanacOrca.png', frames: 6, renderScale: 3.59, name: 'Orca', rarity: 'epic', price: 200, hungerValue: 4.5, desc: 'Legendary predator of the deep trench.', scale: 1.5 },
    ...
    beluga: { src: 'assets/fish/Beluga.png', almanacSrc: 'assets/almanac/almanacBeluga.png', frames: 4, renderScale: 3.5, name: 'Beluga', rarity: 'legendary', price: 800, hungerValue: 5, desc: 'Territorial marine mammal of the abyss.', scale: 1.8 },
    ...
    kraken: { src: 'assets/fish/kraken.png', almanacSrc: 'assets/almanac/almanacKraken.png', frames: 4, renderScale: 7, name: 'Kraken', rarity: 'legendary', price: 1000, hungerValue: 5, desc: 'The ultimate apex monster of the deep.', scale: 2.0 }
};
