...
export const SPRITE_DATA = {
    ...
    clownfish: { src: 'assets/fish/clownfish.png', almanacSrc: 'assets/almanac/almanacClownfish.png', frames: 5, renderScale: 1.18, name: 'Clownfish', rarity: 'common', price: 15, desc: 'Bright orange with white stripes. Rarely strays far from the safety of its home.', scale: 1 },
    ...
    shark: { src: 'assets/fish/shark.png', almanacSrc: 'assets/almanac/almanacShark.png', frames: 5, renderScale: 2.45, name: 'Shark', rarity: 'rare', price: 70, desc: 'A rare fish with a head shaped like blooming petals. Its vibrant colors and elegant movement make it a beautiful sight in calm waters.', scale: 1 },
    turtle: { src: 'assets/fish/turtle.png', almanacSrc: 'assets/almanac/almanacTurtle.png', frames: 5, renderScale: 2.88, name: 'Turtle', rarity: 'rare', price: 75, desc: 'A bizarre, flattened giant that often basks sideways near the surface, but dives deep for jellyfish.', scale: 1.8 },
    orca: { src: 'assets/fish/orca.png', almanacSrc: 'assets/almanac/almanacOrca.png', frames: 6, renderScale:2.59, name: 'Orca', rarity: 'epic', price: 200, desc: 'A rare deep-sea fish with a glowing crescent tail that resembles a half moon. Known to appear only in calm waters at night, making it a prized catch among legendary anglers.', scale: 1.8 },
