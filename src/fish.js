...
export const SPRITE_DATA = {
    ...
    clownfish: { src: 'assets/fish/clownfish.png', almanacSrc: 'assets/almanac/almanacClownfish.png', frames: 5, renderScale: 1.18, name: 'Clownfish', rarity: 'common', price: 15, desc: 'A vibrant reef dweller known for its bright colors and symbiotic bond with sea anemones. Rarely strays far from its home.', scale: 2.7 },
